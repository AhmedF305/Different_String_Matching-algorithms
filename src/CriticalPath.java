...
//        allTasks.add(start);
        Task L = new Task("L",1);
        Task J = new Task("J",8);
        Task K = new Task("K",22 );
        Task H = new Task("H",12,J);
        Task I = new Task("I",15,J);
        Task F = new Task("F",21,H);
        Task G = new Task("G",2,I,K);
        Task E = new Task("E",22,G);
        Task C = new Task("C",14,E);
        Task D = new Task("D",20,F );
        Task A = new Task("A",5,D,L);
        Task B = new Task("B",6,D,E);
        
        Task start = new Task("Start", 0, A,B,C);
         allTasks.add(end);
          allTasks.add(L);
        allTasks.add(F);
        allTasks.add(J);
